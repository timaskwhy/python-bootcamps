...
'''
Assumption #2
We are playing singles match, and there are 2 players in a game.
'''
num_of_computers = 1
num_of_games = int(input("How many win-streak do you want to achieve?\n"))
lives = 1
win_streak = 0

while lives > 0 and num_of_games > 0:
  choices = []
...
if lives == 0:
  print(f"Oh...Your win streak just end at {win_streak}. Good luck next time.")
else:
  print(f"OMG! You wins {win_streak} consecutive matches!")